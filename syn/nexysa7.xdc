...
create_clock -add -name clk100 -period 10.00 -waveform {0 5} [get_ports {clk100}];
...
set_property PACKAGE_PIN V10 [get_ports button_d]
...
####set_property PACKAGE_PIN B13 [get_ports {ov7670_data[1]}]
####	set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_data[1]}]
######Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
####set_property PACKAGE_PIN F14 [get_ports {ov7670_data[3]}]
####	set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_data[3]}]
######Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
####set_property PACKAGE_PIN D17 [get_ports {ov7670_data[5]}]
####	set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_data[5]}]
######Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
####set_property PACKAGE_PIN E17 [get_ports {ov7670_data[7]}]
...
#####
#####	#set_property PULLUP TRUE [get_ports {ov7670_xclk}]
#######Bank = 15, Pin name = IO_25_15,							Sch name = JB7
#####set_property PACKAGE_PIN K16 [get_ports {ov7670_reset}]
#####set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_reset}]
#####
#######Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
#####set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {ov7670_vsync}]
#####	# set_property IOSTANDARD LVCMOS33 [get_ports {ov7670_vsync}]
#####	#set_property CLOCK_DEDICATED_ROUTE FALSE [get_ports {OV7670_PCLK}]
#####
#####set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov7670_pclk_ibuf]
#####set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov7670_pclk_IBUF]
#####
#######Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
#####set_property PACKAGE_PIN T9 [get_ports {ov7670_sioc}]
...
#####
######set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets led_OBUF[11]]
